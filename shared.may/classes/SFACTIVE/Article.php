...
//echo $this->article["article"];
    ...
    function insert()
    {
        ...
        $query = "INSERT INTO webcast (heading, author, contact, link, address, 
                     phone, mime_type, summary, numcomment, arttype, artmime, html_file,  
                     display, linked_file, created, modified, article, parent_id, rating, language_id)
                     VALUES ('"
                         ...
                         . $this->article["linked_file"] . "',now(), now(),'"

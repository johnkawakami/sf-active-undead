<?php
if ($user_class_defined!=true)
{
define(SALT,'28ur8u0eiothioaoroerjsiofjdsfosjfefef');

$user_class_defined = true;
...
class User
{
    ...
    function add($userfields)
    {
        ...
        if (strlen($userfields['username']) != 0 && strlen($userfields['password']) != 0)
        {
            ...
            $error_num = $db_obj->execute_statement($user_add_query);
        } else
        {
            $error_num = 1;
        }
    ...
    function update($userfields)
    {
        ...
        if (strlen($userfields['user_id']) != 0 && strlen($userfields['username']) != 0)
        {
            ...
            $error_num = $db_obj->execute_statement($user_update_query);
    ...
    function delete($user_id)
    {
        ...
        if (strlen($user_id)!=0)
        {
            ...
            $error_num = $db_obj->execute_statement($user_delete_query);
            $error_num=0;
        } else
        {
            $error_num = 1;

...
<center>
<div style="width: 468"><a href="/"><img style="font-family: MS Sans 
Serif, Verdana, Arial, sans-serif; text-align: center" 
src="/images/imc_banner.gif" width="468" height="60" border="0"></a>

<p style="font-family: MS Sans Serif, Verdana, Arial, sans-serif;  
text-align: center">The <a
href="http://foldoc.doc.ic.ac.uk/foldoc/foldoc.cgi?query=referer">referer
URL</a> <? if ($_SERVER['HTTP_REFERER']) echo '<small>&lt;<a href="' .
$_SERVER['HTTP_REFERER'] . '">' . $_SERVER['HTTP_REFERER'] .
'</a>&gt;</small>'; ?> from which you are attempting to access this file 
is forbidden.  Please link to the article URL, not the URL of an attached
file.</p>

<p style="font-family: MS Sans Serif, Verdana, Arial, sans-serif;
text-align: center"><b>Why are we disallowing some referer URLs?</b> The
...
text-align: center">Questions? <a href="mailto:imc-sf-tech[at]indymedia.org">imc-sf-tech at indymedia.org</a></address>
